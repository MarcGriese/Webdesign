    ...
    return (
        <section className="datenschutz">
            <div className="datenschutz__content">
                <h1 className="datenschutz__header" style={{ wordBreak: "break-all", hyphens: "auto" }}>
                ...
                <div className="datenschutz_section">
                    <h2 className="datenschutz__header-sub">
                    ...
                    <p className="datenschutz__text">
                        ...
                        Bestellungen oder sonstige Auftragsanfragen verarbeitet.<br /><br />
                    </p>
                ...
                <div className="datenschutz_section">
                    ...
                    <p className="datenschutz__text">
                        ...
                        <a href="https://www.ionos.de/terms-gtc/terms-privacy" style={{ color: 'white', textDecoration: 'underline' }}>https://www.ionos.de/terms-gtc/terms-privacy</a> <br /><br />
                        ...
                        umfasst. Die Einwilligung ist jederzeit widerrufbar.<br /><br />
                    </p>
                ...
                <div className="datenschutz_section">
                    ...
                    <p className="datenschutz__text">
                        ...
                        E-Mail: contact@mg-webdev.com<br /><br />
                    ...
                    <p className="datenschutz__text">
                        ...
                        Absätzen dieser Datenschutzerklärung informiert.<br /><br />
                    </p>
                    <h3>
                    ...
                    <p className="datenschutz__text">
                        ...
                        gemeinsame Verarbeitung geschlossen.<br /><br />
                    </p>
                    <h3>
                ...
                <div className="datenschutz_section">
                    ...
                    <p className="datenschutz__text">
                        ...
                        Grundlage von Art. 6 Abs. 1 lit. f DSGVO gespeichert, sofern keine andere Rechtsgrundlage angegeben wird.<br /><br />
                    ...
                    <p className="datenschutz__text">
                        ...
                        hierzu müssen die Server-Log-Files erfasst werden.<br /><br />
                    </p>
                    <h3>
                        Kontaktformular
                    </h3>
                    ...
                    <p className="datenschutz__text">
                        ...
                        personenbezogenen Daten (Name, Anfrage) zum Zwecke der Bearbeitung Ihres Anliegens
                ...
                <div className="datenschutz_section">
                    ...
                    <p className="datenschutz__text">
                        ...
                        <a href="https://developers.google.com/fonts/faq" style={{ color: 'white', textDecoration: 'underline' }}>Google Fonts FAQ</a> und in der Datenschutzerklärung von Google: <br />
                        <a href="https://developers.google.com/fonts/faq" style={{ color: 'white', textDecoration: 'underline' }}>Google Fonts Datenschutz</a>.
                    </p>
                </div>
            </div>
        </section >
