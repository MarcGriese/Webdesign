            ...
            <div className="contact__container">
                <div className="contact-content__container">
                    ...
                    <p className="text-contact__container">
                        If you’d like to talk about a project you want help with, just drop m a message at <span className="text-contact-bold">contact@mg-webdev.com</span> I’m currently available for any design projects, dashboard designs or landing pages gigs.
                    </p>
